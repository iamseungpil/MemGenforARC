#!/bin/bash
#
# Evaluation script: Prompt Augmentation Only (No Inference Augmentation) - SmolLM3-3B
#
...
#
# Purpose: Test whether inference augmentation contributes to performance

export CUDA_VISIBLE_DEVICES=0
export WANDB_MODE=online
export WANDB_ENTITY=gistdslab
export WANDB_PROJECT=memgen_reproduce
export WANDB_RUN_NAME="eval_gsm8k_smollm3-3b_skip-lora_no-inference-aug"
...
MAX_PROMPT_AUG_NUM=1      # Prompt augmentation: ENABLED
MAX_INFERENCE_AUG_NUM=0   # Inference augmentation: DISABLED (this is what we're testing!)
...
# Output log
LOG_FILE="./logs/eval_no_inference_aug_$(date +%Y%m%d_%H%M%S).log"
mkdir -p ./logs

echo "========================================"
echo "Evaluation: No Inference Augmentation (SmolLM3-3B)"
echo "========================================"
