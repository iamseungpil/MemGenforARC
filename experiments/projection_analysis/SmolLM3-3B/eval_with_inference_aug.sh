#!/bin/bash
#
# Evaluation script: With Inference Augmentation (Full) - SmolLM3-3B
#
...
export WANDB_RUN_NAME="eval_gsm8k_smollm3-3b_skip-lora_with-inference-aug"
...
echo "========================================"
echo "Evaluation: With Inference Augmentation (SmolLM3-3B)"
echo "========================================"
