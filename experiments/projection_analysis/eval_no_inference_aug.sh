#!/bin/bash
#
# Evaluation script: Prompt Augmentation Only (No Inference Augmentation)
#
...
export WANDB_RUN_NAME="eval_gsm8k_qwen3-8b_skip-lora_no-inference-aug"
...
echo "========================================"
echo "Evaluation: No Inference Augmentation"
echo "========================================"
