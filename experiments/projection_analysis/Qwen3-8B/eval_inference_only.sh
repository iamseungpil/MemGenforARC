#!/bin/bash
#
# Evaluation script: Inference Augmentation Only (No Prompt Augmentation) - Qwen3-8B
#
...
export WANDB_RUN_NAME="eval_gsm8k_qwen3-8b_inference-only"
...
echo "========================================"
echo "Evaluation: Inference Only (Qwen3-8B)"
echo "========================================"
