#!/bin/bash
# ============================================================================
# Skip-Projection Mode Training (Query Latents + LLM, NO Projections)
# ============================================================================
# Tests whether projections are necessary for MemGen training
# ============================================================================
...
export WANDB_RUN_NAME="train_skip_projection_$(date +%Y%m%d_%H%M%S)"
export DEBUG_MODE=true
export CUDA_VISIBLE_DEVICES=1
export MAIN_PROCESS_PORT=29601
...
echo "============================================"
echo "Skip-Projection Mode Training"
echo "============================================"
echo "Model: ${MODEL_NAME}"
echo "Dataset: ${DATASET_NAME}"
echo "Method: ${TRAIN_METHOD}"
echo "Mode: skip_projection=True (Query Latents + LoRA, NO Projections)"
...
python -m accelerate.commands.launch \
    ...
    2>&1 | tee logs/train_skip_projection_$(date +%Y%m%d_%H%M%S).log

echo "============================================"
echo "Skip-Projection training completed!"
echo "============================================"
